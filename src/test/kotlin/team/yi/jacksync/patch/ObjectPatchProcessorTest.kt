...
class ObjectPatchProcessorTest : BaseTest() {
    ...
    fun beforeEach() {
        ...
        patchProcessor = ObjectPatchProcessor(mapper)
    }
    ...
    fun serverSyncV1() {
        ...
        val addOperation: PatchOperation = AddOperation(
            ...
            mapper.valueToTree("my test title")
        )
    ...
    fun clientSyncV2() {
        ...
        val addOperation: PatchOperation = AddOperation(
            JacksonUtils.toJsonPointer("/title"),
            mapper.valueToTree("my 2nd test title")
        )
    ...
    fun clientSyncV3() {
        ...
        val operations = ObjectDiffMapper(mapper).diff(postV1, postV2)
        val jsonOperations = mapper.writerFor(object : TypeReference<List<PatchOperation>>() {}).writeValueAsString(operations)
